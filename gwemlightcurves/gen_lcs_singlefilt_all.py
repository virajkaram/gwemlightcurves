...
for l in ls:
	print('Now doing l')
	t = KNTable.read_samples('../input/%s_ejecta_masses.dat'%(l.split('.dat')[0]),Nsamples=1000)
	...
	pickle.dump(model_table,open('../output/%s_%sband_phi%s_abscos.pickle'%(l.split('.dat')[0],filt,phi),'wb'))
